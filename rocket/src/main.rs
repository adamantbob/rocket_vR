...
// use rocket_drivers::{
//     LedState,
//     gps_task, imu_task_driver, radio_task_driver, sd_card_task_driver,
//     wifi_task_driver,
// };
...
pub use rocket_core::utilization::METRICS_CORE0;
...
fn main() -> ! {
    ...
    let _spawner = exec_high.start(interrupt::SWI_IRQ_1);
    ...
    executor0.run(|spawner| {
        ...
        spawn_tracked!(spawner, PANIC_MONITOR0, panic_monitor_task(0));
        spawn_tracked!(spawner, BLINKY, blinky(hw.led_red));

        // TODO: Spawn hardware tasks here.
        ...
        // spawn_tracked!(spawner, RADIO, radio_task(hw.radio_spi, hw.radio_cs, hw.radio_reset, hw.radio_dio0));
        spawn_tracked!(
            spawner,
            USB,
